...
import { IconWarning, IconSparkle, IconArrowLeft } from "./icons";
          ...
          {result.token && (
            <div className="token-display">
              ...
              <p className="token-warning">
                <IconWarning size={12} /> This token will not be shown again — copy it now.
              </p>
            </div>
          )}
    ...
    <div className="form-container">
      ...
      {autoDetected && (
        <div className="auto-detect-notice">
          <IconSparkle size={13} /> Pre-filled from your project files — review before submitting.
        </div>
      )}
